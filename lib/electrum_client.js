...
class ElectrumClient extends Client{
    ...
    statushashCompare_start(){
        return this.request('statushash.compare.start', [])
    }

    statushashCompare_get_status(){
        return this.request('statushash.compare.status', [])
    }
    ...
    blockchainAddresses_getBalance(addresses){
        return this.request('blockchain.address.get_balance', addresses)
    }
    ...
    blockchainAddresses_getHistory(addresses){
        return this.request('blockchain.address.get_history', addresses)
    }
